...
import blindspot_duel.config.settings as settings_module
from blindspot_duel.config.config_manager import ConfigManager
from blindspot_duel.config.settings import WIDTH, HEIGHT
from blindspot_duel.config.messages import SETTINGS_TITLE, SETTINGS_SUBTITLE, SETTINGS_FOOTER

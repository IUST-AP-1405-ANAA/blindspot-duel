...
from blindspot_duel.entities.player.player_model import Player
from blindspot_duel.entities.player.crosshair import Crosshair
from blindspot_duel.mechanics.spawning.target_lifecycle import TargetManager
from blindspot_duel.mechanics.physics.movement_system import move_crosshair
from blindspot_duel.mechanics.physics.boundary_clamp import clamp_position
from blindspot_duel.mechanics.combat.shooting_logic import process_shot
from blindspot_duel.ui.hud.player_dashboard import PlayerDashboard
from blindspot_duel.database.dtos import MatchResultDTO
...
from blindspot_duel.config.messages import ITEM_AMMO_LABEL, ITEM_GLITCH_LABEL
...
class PlayingState(IState):
    ...
    def render(self, renderer: IRenderable) -> None:
        from blindspot_duel.entities.targets.standard_target import StandardTarget
        from blindspot_duel.entities.items.ammo_box import ItemAmmoBox
        from blindspot_duel.entities.items.time_boost import ItemTimeBoost
        from blindspot_duel.entities.items.glitch_debuff import ItemGlitch

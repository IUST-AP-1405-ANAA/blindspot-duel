...
from blindspot_duel.config.settings import FONT_NAME, FONT_SHADOW_OFFSET, DEFAULT_FONT_SIZE
from blindspot_duel.config.colors import TEXT_COLOR, SHADOW_COLOR

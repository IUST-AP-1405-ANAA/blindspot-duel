...
from src.config.messages import MATCH_RESULTS_TITLE, MATCH_RESULTS_SUBTITLE, MATCH_RESULTS_WINNER, MATCH_RESULTS_TIE, MATCH_RESULTS_STATS, MATCH_RESULTS_FOOTER
